          ...
          <div class="col-md-12">
            <div class="row justify-content-center mb-4">
              <div class="col-md-8 text-center">
                ...
                <p data-aos="fade-up" data-aos-delay="100">What do you need?</p>
              </div>
            </div>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                    <div class="select-wrap">
                      ...
                      <select class="form-control rounded" name="input_school" id="input_school">
                        <option value="">...</option>
                        <option value="">...</option>
                        <option value="">...</option>
                        <option value="">...</option>
          ...
          <div class="row align-items-stretch no-gutters">
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="#" class="popular-category h-100">
                ...
                <span class="caption mb-2 d-block">Profile</span>
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="#" class="popular-category h-100">
                ...
                <span class="caption mb-2 d-block">Recruitment</span>
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="#" class="popular-category h-100">
                ...
                <span class="caption mb-2 d-block">School</span>
